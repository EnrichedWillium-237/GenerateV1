...
void intV1_eta()
{
        ...
        for (int i = 0; i<nanals; i++) {
            for (int cbin = 0; cbin<ncentbins; cbin++) {
                v1Stat_eta[i][cbin]->SetMarkerColor(kBlue);
                v1Stat_eta[i][cbin]->SetLineColor(kBlue);
                v1Stat_eta[i][cbin]->SetMarkerStyle(21);
                v1Stat_eta[i][cbin]->SetMarkerSize(1.1);

                v1Syst_eta[i][cbin]->SetMarkerColor(kBlue);
                v1Syst_eta[i][cbin]->SetLineColor(kBlue);
                v1Syst_eta[i][cbin]->SetMarkerStyle(21);
                v1Syst_eta[i][cbin]->SetMarkerSize(1.1);
                v1Syst_eta[i][cbin]->SetFillColor(kRed-9);
            }
        }
        ...
        for (int cbin = 0; cbin<ncentbins; cbin++) {
            ...
            v1Stat_eta[anal][cbin]->Draw("same");
