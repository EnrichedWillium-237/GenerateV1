...
# root -l -b -q '/home/w955m639/v1flow/2015_PbPb/MixedV1/GenerateV1.C+("v1SP_122", "inlist.dat", 50)'
root -l -b -q '/home/w955m639/v1flow/2015_PbPb/MixedV1/GenerateV1.C+("v1SP_122", "inlist.dat", 5000)' > logs/v1SP_122.logs
cd ..
